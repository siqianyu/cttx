...
<script language="javascript" type="text/javascript">
    jQuery("#startech_table_jqgrid").jqGrid({
        ...
        datatype: "json",
        colNames: ['会员编号', '会员名', '手机号码', '真实姓名', '性别', '审核状态', '账户余额', '禁用状态', '操作'],
        colModel: [
            { name: 'MemberId', index: 'MemberId', width: 60 },
            { name: 'MemberName', index: 'MemberName', width: 60, align: 'center' },
            { name: 'Mobile', index: 'Mobile', width: 90, align: 'center', classes: 'goodsimgstyle' },
